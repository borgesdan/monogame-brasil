...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    /// </summary>
    public struct AttackBox : IEquatable<AttackBox>, ISpriteBox<AttackBox>
    {
        ...
        public AttackBox(int power, Rectangle rectangle, params byte[] tags)
        {
            X = rectangle.X;
            Y = rectangle.Y;
        ...
        public AttackBox GetRelativePosition(Rectangle frame, Rectangle target, Vector2 scale, SpriteEffects flip)
        {
            ...
            AttackBox cb = new AttackBox(Power, rectangle,
