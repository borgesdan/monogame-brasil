...
{
    public struct CollisionBox : IEquatable<CollisionBox>, ISpriteBox<CollisionBox>
    {
        ...
        public CollisionBox(Rectangle rectangle, bool canCollide, bool canTakeDamage, float damagePercentage, params byte[] tags)
        {
            X = rectangle.X;
            Y = rectangle.Y;
        ...
        public CollisionBox GetRelativePosition(Rectangle frame, Rectangle target, Vector2 scale, SpriteEffects flip)
        {
            ...
            CollisionBox cb = new CollisionBox(rectangle, CanCollide, CanTakeDamage, DamagePercentage,
        ...
        {
            return CanCollide == box.CanCollide &&
